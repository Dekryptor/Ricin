...
/**
* This class defines a basic Tox action message.
...
public class Ricin.Action : IMessages, Object {
  ...
  **/
  public Action (string message, DateTime timestamp = new DateTime.now_local ()) {
    this.is_action = true;
  ...
  **/
  public Action.Incoming (Contact sender, string message, DateTime timestamp = new DateTime.now_local ()) {
    this.is_action = true;
  ...
  **/
  public Action.Outgoing (Contact receiver, string message, DateTime timestamp = new DateTime.now_local ()) {
    this.is_action = true;
