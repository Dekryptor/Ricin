...
/**
* This class defines a Tox groupchat message.
* @implements IMessages
*/
public class Ricin.GroupMessage : IMessages, Object {
  /**
  ...
  **/
  public GroupMessage (string message, DateTime timestamp = new DateTime.now_local ()) {
  ...
  **/
  public GroupMessage.Incoming (Contact sender, string message, DateTime timestamp = new DateTime.now_local ()) {
  ...
  **/
  public GroupMessage.Outgoing (Contact receiver, string message, DateTime timestamp = new DateTime.now_local ()) {
