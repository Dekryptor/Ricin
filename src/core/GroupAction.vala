...
public class Ricin.GroupAction : IMessages, Object {
  ...
  **/
  public GroupAction (string message, DateTime timestamp = new DateTime.now_local ()) {
    this.is_action = true;
  ...
  **/
  public GroupAction.Incoming (Contact sender, string message, DateTime timestamp = new DateTime.now_local ()) {
    this.is_action = true;
  ...
  **/
  public GroupAction.Outgoing (Contact receiver, string message, DateTime timestamp = new DateTime.now_local ()) {
    this.is_action = true;
